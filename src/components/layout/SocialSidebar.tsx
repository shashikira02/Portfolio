            ...
            <div className='fixed right-6 bottom-0 hidden md:flex flex-col items-center z-50'>
                <div className='relative'>
                    ...
                    >
                     ...
                     {/* <button
                        onClick={copyEmail}
                        className={`[writing-mode:vertical-rl] text-sm tracking-widest hover:-translate-y-1 transition-all duration-200 mb-6 ${copied ? 'text-green-400' : 'hover:text-white/80'}`}
                    >
                        {email}
                    </button> */}
